...
class brand
{
    ...
    public function insert_brand($brandName)
    {
        ...
        if (empty($brandName)) {
            $alert = "<span class='error'> Brand must be empty </span>";
            return $alert;
        } else {
    ...
    public function update_brand($brandName, $id)
    {
        ...
        if (empty($brandName)) {
            ...
            if ($result) {
                $alert = "<span class='success'> Brand Updates Successfully </span>";
                return $alert;
            } else {
                $alert = "<span class='error'> Brand Updates Not Success </span>";
                return $alert;
            }
        }
    }
